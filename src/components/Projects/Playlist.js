              ...
              {projectData.map((el, index) => (
                <Card key={index} className="project-card mt-4 mb-4">
                  ...
                  <Card.Body className="d-flex justify-content-center flex-column">
                    <Card.Title className="text-center text-blue">
                      {el.projectName}
                    </Card.Title>
                    <div className="des">
                      <p>{el.desc}</p>
                    ...
                    <div className="proj-buttons d-flex justify-content-between">
                      ...
                      >
                        <Button variant="info visit">View Project</Button>
                      </a>
                      ...
                      <a
                        ...
                        className="text-decoration-none text-blue"
                      >
                        <Button variant="info visit">Code</Button>
                      </a>
                    </div>
                  </Card.Body>
                </Card>
